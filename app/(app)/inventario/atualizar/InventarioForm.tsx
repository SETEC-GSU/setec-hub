        ...
        <div className="space-y-6">
          ...
          <div className="space-y-2 border-t border-slate-800 pt-6">
             ...
             <textarea
               ...
               rows={4}
               className="w-full bg-slate-900 border border-slate-800 rounded-xl p-4 text-sm text-white resize-none outline-none focus:border-cyan-500 transition-colors"
             />
          </div>

          <p className="text-xs text-slate-400 bg-slate-900/50 p-3 rounded-lg border border-slate-800">
            ⚠️ As informações declaradas neste inventário são de responsabilidade
            do servidor responsável pelo preenchimento.
          </p>
        </div>
      </Card>

      <Button type="submit" className="w-full md:w-auto py-3 px-8 text-base">
